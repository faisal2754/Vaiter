...
public class ListAdapterTab3 extends BaseAdapter{
    tab3 context;
    private final ArrayList<String> meals;
    private final ArrayList<String> dateTime;
    private final ArrayList<Integer> images;

    public ListAdapterTab3(tab3 context, ArrayList<String> meals, ArrayList<String> dateTime, ArrayList<Integer> images){
