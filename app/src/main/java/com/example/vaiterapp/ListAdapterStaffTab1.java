...
public class ListAdapterStaffTab1 extends BaseAdapter{
    StaffTab1 context;
    private final ArrayList<String> meals;
    private final ArrayList<String> names;
    private final ArrayList<String> dateTime;

    public ListAdapterStaffTab1(StaffTab1 context, ArrayList<String> meals, ArrayList<String> names, ArrayList<String> dateTime){
